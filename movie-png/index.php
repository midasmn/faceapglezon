...
$title = "動画から画像ファイル抜き出し->PNG"; 
$keywords = "動画 PNGファイル分解,Webサービス imagemagick ffmpeg";
$description = "動画から画像ファイル抜き出し->PNG";

$og_title = $title;
$og_image = "http://faceapglezon.info/movie-png/img/tools_png.png";
$og_url = "http://faceapglezon.info/movie-png/png.php";
$og_site_name = $title;
$og_description = $description;
//

//
$h1_st = "動画から画像ファイル抜き出し->PNG";
$h1_st_s = "  最大サイズ=".$max_up_size."まで";
/////
$site_name = "faceapglezon";
$footer_sitename = "faceapglezon";
$culhtml = "http://faceapglezon.info/movie-png";
...
<script>
	function upload(form) {
            ...
            $.ajax(
                'http://faceapglezon.info/movie-png/upload_png.php',
                {
                type: 'post',
                processData: false,
                contentType: false,
    ...
    <div class="row" style="margin-top:10px;" >
      ...
      <div class="col-md-8">
        <div class="page-header">
          <h1><?=$h1_st?><br><small>動画ファイルから秒3コマのPNGファイルを作成します</small></h1>
        </div>
        ...
        <div id="note" class="col-md-12" style="margin-top:150px;">
          ...
          <h3><p>動画ファイル(mp4、flv、mov、mpeg)から1秒あたり3コマの336ピクセルのPNGファイルを作成します。</p></h3>
          ...
          <img src="img/tools_png.png" class="img-responsive img-thumbnail" alt="処理結果イメージ">
        </div>
        <!-- 動画抜き出しPNGギャラリー -->
        <div id="rtn_div"></div>
      </div>
...
<!-- Shepherd -->
<!-- <script src="../js/shephead_mpg.js"></script> -->
<!-- アップロード -->
<script>
$(function(){
