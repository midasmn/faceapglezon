...
$zip = new ZipArchive();
// Zipファイル名
$zipFileName = 'movie-png.zip';
// Zipファイル一時保存ディレクトリ
$zipTmpDir = '/usr/share/nginx/html/faceapglezon.info/movie-png/zip/';
...
$TMP_PATH ="/usr/share/nginx/html/faceapglezon.info/movie-png/tmp/".$exm_dir."/";
$image_data_array = get_files_zip($TMP_PATH);

$HTTP_PATH ="http://faceapglezon.info/movie-png/tmp/".$exm_dir."/";
