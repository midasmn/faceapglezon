...
//
$og_title = $title;
$og_image = 'http://faceapglezon.info/httmltoimage/og_image.php?url='.(empty($_SERVER["HTTPS"]) ? "http://" : "https://") . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"];
$og_url = "http://faceapglezon.info/httmltoimage/index.php";
$og_site_name = $title;
$og_description = $description;

$h1_st = $title;
// $h1_st_s = "  現在21サイズ対応";
$culhtml = "http://faceapglezon.info/httmltoimage/";
...
function upload(form) 
{
  ...
  $.ajax(
      'http://faceapglezon.info/httmltoimage/upload.php',
      {
      type: 'post',
      processData: false,
      contentType: false,
      ...
      <div class="col-md-8">
        <div class="page-header">
         ...
         <form  id="upload-form" method="post" name="form"  onSubmit="return upload(this);">
          ...
          <div>
          <input type="submit" name="submit"  id="submit-btn" class="btn btn-primary btn-lg " value="URL取得">
          <img src="img/load.gif" id="loading-img" style="display:none;" alt="Please Wait"/>
        </div>
        </form>

        <!-- SNS -->
        <div class="sbver" style="margin-top:100px;">
