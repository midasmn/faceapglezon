...
// HTMLの時用
$ICON_PATH = "/usr/share/nginx/html/faceapglezon.info/favicon/tmp/".$exm_dir."/";
$HTML_ICON_PATH = "/favicon/tmp/".$exm_dir."/";
//抜き出しPNG
$rtn_png_st = "";
...
//htmlテキストを読み込む
$rtn_html = "";
$html_PATH ="http://faceapglezon.info/favicon/tmp/".$exm_dir."/icon.txt";
