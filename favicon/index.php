...
$og_title = $title;
$og_image = "http://faceapglezon.info/favicon/img/tools_icon.png";
$og_url = "http://faceapglezon.info/favicon/index.php";
$og_site_name = $title;
$og_description = $description;

$h1_st = "ファビコン・アイコン一括生成Webサービス";
$h1_st_s = "  現在21サイズ対応";
$culhtml = "http://faceapglezon.info/favicon";
...
function upload(form)
{
  ...
  $.ajax(
      'http://faceapglezon.info/favicon/upload.php',
      {
      type: 'post',
      processData: false,
      contentType: false,
    ...
    <div class="row" style="margin-top:10px;" >
      ...
      <div class="col-md-8">
        ...
        <div id="note" class="col-md-12" style="margin-top:150px;">
          ...
          <img src="http://faceapglezon.info/favicon/img/tools_icon.png" class="img-responsive img-thumbnail" alt="処理結果イメージ">
        </div>
        <!-- 動画抜き出しPNGギャラリー -->
        <div id="rtn_div"></div>
      </div>
