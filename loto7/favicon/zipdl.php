...
// Zipファイル一時保存ディレクトリ
$zipTmpDir = '/usr/share/nginx/html/faceapglezon.info/tools/icon/zip/';
...
$TMP_PATH ="/usr/share/nginx/html/faceapglezon.info/tools/icon/tmp/".$exm_dir."/";
$image_data_array = get_files_zip($TMP_PATH);

$HTTP_PATH ="http://faceapglezon.info/tools/icon/tmp/".$exm_dir."/";
