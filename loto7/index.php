...
$footer .= '<!-- loto7 -->';
$footer .= '<ins class="adsbygoogle"';
$footer .= '     style="display:inline-block;width:320px;height:100px"';
$footer .= '     data-ad-client="ca-pub-6625574146245875"';
$footer .= '     data-ad-slot="8002916400"></ins>';
$footer .= '<script>';
$footer .= '(adsbygoogle = window.adsbygoogle || []).push({});';
$footer .= '</script>';
...
<!-- OG -->
<meta property="og:title" content="LOTO7-第<?php echo $nextNO; ?>回当選番号" />
 ...
 -->    <a href="#entry" data-icon="plus" class="ui-btn-right">メール登録</a>
    ...
    <div data-role="content">
      ...
      if($mode=="read")
      {
        ...
        <div id="no">
          <ul>
            <li><span><?php echo $winCNT_arr[0];?></span></li>
            <li><span><?php echo $winCNT_arr[1];?></span></li>
            <li><span><?php echo $winCNT_arr[2];?></span></li>
            <li><span><?php echo $winCNT_arr[3];?></span></li>
            <li><span><?php echo $winCNT_arr[4];?></span></li>
            <li><span><?php echo $winCNT_arr[5];?></span></li>
            <li><span><?php echo $winCNT_arr[6];?></span></li>
          </ul>
        </div>
        <div class="clear"></div>
    <hr>
    <form action="" method="post">
      ...
      ?>
        <p>LOTO7第<?php echo $latestNO;?>回(<?php echo $cnt_date;?>)当選番号</p>
    <div id="no_area">
      <ul>
        <li><div id="star-five_red"></div></li>
        <li><div id="star-five_blue"></div></li>
    ...
    <div id="no">
      <ul>
        <li><span><?php echo $latest_arr[1];?></span></li>
        <li><span><?php echo $latest_arr[2];?></span></li>
        <li><span><?php echo $latest_arr[3];?></span></li>
        <li><span><?php echo $latest_arr[4];?></span></li>
        <li><span><?php echo $latest_arr[5];?></span></li>
        <li><span><?php echo $latest_arr[6];?></span></li>
        <li><span><?php echo $latest_arr[7];?></span></li>
      </ul>
    </div>
    <div class="clear"></div>
    <div id="bonus-no">
      <ul>
        <li><span id="bonus"><?php echo $latest_arr[b];?></span></li>
        <li><span id="bonus"><?php echo $latest_arr[b2];?></span></li>
      </ul>
    </div>
    <div class="clear"></div>
    <?php
    ...
    <ul data-role="listview">
      ...
      <li><a href="http://www.mizuhobank.co.jp/takarakuji/loto/loto7/index.html" target="_brank">みずほ銀行宝くじコーナ</a></li>
    </ul>
  </div>
    <?php echo $footer;?>
</div>
...
//-->
          ...
          <input type="email" name="MAIL" id="MAIL" value="<?php $MAIL?>" data-theme="c">
        </div>
        <div data-role="fieldcontain">
...
<div data-role="page" id="performance" data-add-back-btn="true" data-back-btn-text="戻る">
  ...
  <div data-role="content">
    <p>LOTO7予測成績</p>
    総予測件数：<?php echo number_format($relult_all_all);?>件
    <hr>
    当選：<?php echo number_format($result_cnt);?>件(当選金額：<?php echo number_format($result_amount);?>円)
    <hr>
    1等：<?php echo number_format($result_per_cnt1);?>件(当選金額：<?php echo number_format($result_per_amount1);?>円)<br>
    2等：<?php echo number_format($result_per_cnt2);?>件(当選金額：<?php echo number_format($result_per_amount2);?>円)<br>
    3等：<?php echo number_format($result_per_cnt3);?>件(当選金額：<?php echo number_format($result_per_amount3);?>円)<br>
    4等：<?php echo number_format($result_per_cnt4);?>件(当選金額：<?php echo number_format($result_per_amount4);?>円)<br>
    5等：<?php echo number_format($result_per_cnt5);?>件(当選金額：<?php echo number_format($result_per_amount5);?>円)<br>
    6等：<?php echo number_format($result_per_cnt6);?>件(当選金額：<?php echo number_format($result_per_amount6);?>円)
    <hr>
  </div>
     <!-- フッター -->
    <?php echo $footer;?>
