...
$title = "タグのない世界 | Webページからタグを取りのぞきます"; 
$keywords = "タグ,画像,テキスト,コメント,Webページ";
$description = "タグのない世界 | Webページからタグを取りのぞきます。画像、文字だけを羅列します。";
//
$og_title = $title;
$og_image = "http://faceapglezon.info/imageonly/img/tools_icon.png";
$og_url = "http://faceapglezon.info/imageonly/index.php";
$og_site_name = $title;
$og_description = $description;

$h1_st = "タグのない世界";
$h1_st_s = "  Webページからタグを取りのぞきます";
$culhtml = "http://faceapglezon.info/yellowpage";
$crlhtmltitle = "Webページからタグを取りのぞきます";
...
function upload(form) 
{
  ...
  $.ajax(
      'http://faceapglezon.info/imageonly/scraping.php',
      {
      type: 'post',
      processData: false,
      contentType: false,
    ...
    <div class="row" style="margin-top:10px;" >
      ...
      <div class="col-md-8">
        <div class="page-header">
          <h1><?=$h1_st?><br><small>画像と文字だけを抜き出し羅列します</small></h1>
        </div>
        <form  id="upload-form" method="post" name="form"  onSubmit="return upload(this);">
          <div style="width:60%;float:left;margin-right:10px;" class="input-group">
            ...
            <input name="URL" id="URL" type="text" class="form-control input-lg seoup" placeholder="ページURL" >
          </div>
          <input type="submit" name="submit"  id="submit-btn" class="btn btn-primary btn-lg " value="タグ除去">
        ...
        <div id="note" class="col-md-12" style="margin-top:50px;">
          <h2><i class="glyphicon glyphicon-info-sign"></i> このツールでできること</h2>
            <ul>
              <li class="h4">URLのWebページからすべてのタグを取り除いて表示します</li>
