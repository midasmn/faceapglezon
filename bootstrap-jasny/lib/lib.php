...
{
  $OUT_FILE = $OUT_PATH.'/'.$OUT_FILENAME;
  $MASK_FILE = "/usr/share/nginx/html/faceapglezon.info/tools/icon/img/180-mask-white-r85.png";
...
{
	//処理フォルダ
	$TMP="/usr/share/nginx/html/faceapglezon.info/tools/icon/tmp";
...
{
  $TMP_PATH ="/usr/share/nginx/html/faceapglezon.info/tools/icon/tmp/";
